...
public interface Song {
    ...
    /**
     * Returns the unique identifier for this Song, generated by calculating the CRC32 of the
     * song audio file. The CRC32 is based on the entire file, including headers and formatting
     * data, not just the audio stream.
     *
     * @return unique ID
     */
    long getId();
