...
*/
    ...
    protected Socket getConnection(int sendBuffer, int receiveBuffer) throws SocketException, SocketTimeoutException {
        ClientSocket socket = new ClientSocket(this.address, this.port, sendBuffer, receiveBuffer);
        socket.connect();
        return socket;
    }
